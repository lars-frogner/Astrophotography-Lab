...
echo 'Usage: sudo ./astrometry_setup.sh [</path/to/install/to>]'
...
# Make sure we are in the same folder as this script
cd "${SCRIPTPATH}"
...
echo "${INSTALLPATH}" > "${SCRIPTPATH}/astrometry_install_path.txt"
