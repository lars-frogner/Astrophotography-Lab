@set BASE=C:\Users\Lars\Dropbox\Programmering\Astrophotography\"Astrophotography Lab [lrep]"\v0.4.0
@set FOLDER="Astrophotography Lab"
@set ZIPFOLDER="aplab-v0.4.0-win-standalone"
@set README="README_v0.4.0_win.txt"
@set NAME=APLab
...
del /Q %BASE%\__pycache__\"aplab_runner.cpython-36.pyc"
@if %errorlevel% neq 0 exit /b %errorlevel%
